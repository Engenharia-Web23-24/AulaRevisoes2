...
namespace ProjetoRevisoes2.Controllers
{
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Text,Likes,Date")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,Text,Likes,Date")] Post post)
        {
            if (id != post.Id)
            {
                return NotFound();
